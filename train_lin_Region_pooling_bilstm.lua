...
-- Data input settings
cmd:option('-input_img_h5','data_img_s1_VGG16_l30_d512x14x14_o1k_sub.h5','path to the h5file containing the image feature')
...
cmd:option('-CP_name', 'lstm_s1_wct0_VGG16_d196x512_es200_rs512_rl2_cs1024_o1k_sub_iter%d.t7', 'checkpoints file names')
cmd:option('-final_model_name', 'lstm_s1_wct0_VGG16_d196x512_es200_rs512_rl2_cs1024_o1k_sub.t7', 'checkpoints file names')
...
if opt.img_norm == 1 then
  ...
  nm[nm:eq(0)]=1e-5
  nm = torch.repeatTensor(nm, 1, nhimage, 1, 1)
  dataset['fv_im']=torch.cdiv(dataset['fv_im'], nm):float()
end
