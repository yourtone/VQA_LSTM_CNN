...
2. preprocess raw data into question+answer+vocab files
...
VQA_LSTM_CNN$ python prepro.py --input_train_json data/vqa_raw_s1_train_sub.json --input_test_json data/vqa_raw_s1_test_sub.json --num_ans 1000 --output_json data_prepro_s1_wct0_o1k_sub.json --output_h5 data_prepro_s1_wct0_o1k_sub.h5 --word_count_threshold 0
total words: 234395
...
3. generate image features using VGG19/GoogLeNet caffe model
